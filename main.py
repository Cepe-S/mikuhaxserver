...
discordLinks = DiscordLinks(
    ...
    "https://discord.com/api/webhooks/1294345171764248586/D3D2XTB9HL7n7iFV5xlykuX5CAVfc_Kg8p1M9vVQ9P7vNXAxHDEc3-VwrTuw _Fr4LrqL"
)
...
async def main():
    ...
    driver = wd(["--no-sandbox", "--disable-dev-shm-usage", "--headless", "--log-level=3", "--silent", "--disable-logging"], "/usr/bin/chromedriver", logger)
    server = testserver
